...
def parse_tabular_data_file(content: str) -> pl.DataFrame:
    ...
    The first row is a header. Column 1 is the subject identifier (e.g. ``rat``)
    and the remaining columns are condition names. Each subsequent row contains
    the subject ID followed by one numeric value per condition. Blank lines and
